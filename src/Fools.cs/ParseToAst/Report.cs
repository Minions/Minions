...
namespace Fools.cs.ParseToAst
{
	public class Report
	{
		[NotNull] private readonly ProgramFragment _result;
		...
		private bool error([NotNull] ErrorReport error_report)
		{
			_result.errors.Add(error_report);
			return false;
		}

		private bool fatal([NotNull] ErrorReport error_report)
		{
